...
const detalleProducto = document.querySelector(".product-detail-secundary");
const closeDetail = document.querySelector(".product-detail-close-secundary");
...
closeDetail.addEventListener("click", closeButton);
...
for (product of productList) {
  ...
  productImages.forEach(image => {
    console.log(image)
    image.addEventListener('click', openItems);
  });  
}  
